  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-950 to-slate-900">
      ...
      <div className="text-center py-24 px-8">
        <div className="inline-flex items-center gap-2 bg-purple-500/20 text-purple-300 text-sm font-semibold px-4 py-2 rounded-full mb-8 border border-purple-500/30">
        ...
        <p className="text-gray-400 text-xl max-w-2xl mx-auto mb-12 leading-relaxed">
          Uploadez vos cours — l'IA génère vos flashcards, quiz et planning de révision.
          ...
          {[
            {
              icon: '🤖',
              title: 'Génération IA',
              desc: 'Gemini analyse vos notes et génère des flashcards, quiz et résumés en secondes.',
            ...
            },
            {
              ...
              desc: 'Répétition espacée scientifique — révisez au bon moment pour mémoriser durablement.',
            ...
            },
            {
              ...
              desc: 'Suivez votre progression avec des graphiques, heatmap et taux de maîtrise.',
            ...
            },
            {
              ...
              desc: 'Entrez votre date d\'examen — l\'IA crée votre planning de révision optimal.',
            ...
            },
            {
              icon: '🔒',
              title: '100% Privé',
              desc: 'Toutes vos données restent sur votre appareil. Aucun serveur, aucun compte requis.',
            ...
            },
            {
              icon: '📱',
              title: 'Responsive',
              desc: 'Révisez partout — sur mobile, tablette ou ordinateur, l\'expérience est parfaite.',
      ...
      <div className="text-center pb-24 px-8">
        <div className="bg-gradient-to-r from-violet-600/20 to-cyan-600/20 rounded-3xl p-12 max-w-3xl mx-auto border border-white/10">
          ...
          <p className="text-gray-400 mb-8">
            Créez votre première matière et commencez en moins de 2 minutes.
          </p>
          <button
            onClick={() => navigate('/subjects')}
